...
echo "${sentimentAnalysisDeploymentId}" > /usr/share/nginx/html/computerVisionProjectDeploymentId
echo "${twitchSentimentAnalysisDeploymentId}" > /usr/share/nginx/html/maxVehicleWindowProjectDeploymentId
nginx -g "daemon off;"