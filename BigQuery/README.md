...
[This project](https://github.com/quixio/quix-samples/tree/main/python/destinations/BigQuery) gives an example of how to stream data from Quix to a BigQuery database, it handles both time-series and event data.
